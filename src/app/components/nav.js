                ...
                <Container fluid="lg" className={`py-3 ${styles.add_border}`}>
                    ...
                    <Navbar.Collapse className="justify-content-end d-none d-lg-block">
                        <Nav className="me-auto" >
                            <Nav.Link className={`${props.page == 'contact' || props.page == 'review' ? '' : 'scroll-to'} me-3`} href={`${props.page == 'contact' || props.page == 'review' ? '/#' : ''}home`}>Home</Nav.Link>
                            <Nav.Link className={`${props.page == 'contact' || props.page == 'review' ? '' : 'scroll-to'} me-3`} href={`${props.page == 'contact' || props.page == 'review' ? '/#' : ''}features`}>About Us</Nav.Link>
                            <Nav.Link className={`${props.page == 'contact' || props.page == 'review' ? '' : 'scroll-to'} me-3`} href={`${props.page == 'contact' || props.page == 'review' ? '/#' : ''}pricing`}>Services</Nav.Link>
                            <Nav.Link className={`${props.page == 'contact' || props.page == 'review' ? '' : 'scroll-to'} me-3`} href={`${props.page == 'contact' || props.page == 'review' ? '/#' : ''}reviews`}>Reviews</Nav.Link>
